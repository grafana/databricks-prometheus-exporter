{
  new(this): {
    ...
    rules: [
      ...
      },
      {
        ...
        expr: |||
          (
            ...
            / median_over_time(databricks_job_run_duration_seconds{quantile="0.95"}[7d])
      ...
      },
      {
        ...
        expr: |||
          (
            ...
            / median_over_time(databricks_pipeline_run_duration_seconds{quantile="0.95"}[7d])
      ...
      {
        alert: 'DatabricksCriticalPipelineDurationRegression',
        expr: |||
          (
            databricks_pipeline_run_duration_seconds{quantile="0.95"}
            / median_over_time(databricks_pipeline_run_duration_seconds{quantile="0.95"}[7d])
      ...
      },
      {
        ...
        expr: |||
          (
            ...
            / median_over_time(databricks_query_duration_seconds{quantile="0.95"}[7d])
      ...
      {
        alert: 'DatabricksCriticalSqlQueryLatencyRegression',
        expr: |||
          (
            databricks_query_duration_seconds{quantile="0.95"}
            / median_over_time(databricks_query_duration_seconds{quantile="0.95"}[7d])
