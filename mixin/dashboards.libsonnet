...

{
  ...
  new(this)::
    ...
    local timezone = this.config.dashboardTimezone;
    {
          ...
          g.util.panel.resolveCollapsedFlagOnRows(
            g.util.grid.wrapPanels(
              [
                ...
                this.grafana.rows.overviewHeatmap,
      ...
      'databricks-workloads-sql.json':
        g.dashboard.new(prefix + ' workloads & SQL')
          ...
          g.util.panel.resolveCollapsedFlagOnRows(
            g.util.grid.wrapPanels(
              [
                ...
                this.grafana.rows.workloadsFailures,
      ...
      'databricks-sql-bi-deep-dive.json':
        g.dashboard.new(prefix + ' SQL/BI deep dive')
          ...
          g.util.panel.resolveCollapsedFlagOnRows(
            g.util.grid.wrapPanels(
              [
                ...
                this.grafana.rows.sqlbiTopQueries,
